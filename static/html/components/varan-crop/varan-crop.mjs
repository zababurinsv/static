...
customElements.define('varan-crop',
  class extends HTMLElement {
    constructor () {
      ...
      function getSliderTemplate (obj) {
        return new Promise(function (resolve, reject) {
          // console.assert(false, `/static/html/components/varan-slider/template/${obj['slot']}.html`)
      ...
      function scriptTemplate (obj, parent) {
        return new Promise(function (resolve, reject) {
          ...
          if (verify === true) {
            ...
            // console.assert(false, `/static/html/components/${obj.tagName.toLowerCase()}/${obj.tagName.toLowerCase()}.js`)
            console.log('@@@@@@@@2@@@@@@@@', `/static/html/components/${obj.tagName.toLowerCase()}/${obj.tagName.toLowerCase()}.js`)
      ...
      async function modules (obj) {
        ...
        action({
         ...
         obj['this'].shadowRoot.querySelector('.close').addEventListener('click', function uploadEvent (event) {
         obj['this'].shadowRoot.querySelector('.modal').style.display = 'none'
        })
      }
    }
  })
