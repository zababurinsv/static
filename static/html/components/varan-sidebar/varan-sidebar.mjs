...
customElements.define('varan-sidebar',
    ...
    constructor () {
      ...
      async function module (obj) {
        ...
        action({
          input:'varan-sidebar',
          this: obj['this'],
          name: obj['this'].shadowRoot.querySelector('#name'),
          image: obj['this'].shadowRoot.querySelector('#image'),
          title: obj['this'].shadowRoot.querySelector('#titleItem'),
          date:  Date.now(),
          type:'store'
        }, 'set', 'type')
        ...
        //
        //   obj['this'].shadowRoot.querySelector('#file-upload').onchange = function (event) {
        //   obj['this'].shadowRoot.querySelector('#background').innerText =  event.target.files[0].name
        //
        //  let file = new CustomEvent('sideBarUpload', {
        //     detail: {
        //       id: 'varan-editor',
        //       file: event.target.files[0]
        //     }
