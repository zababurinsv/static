...
customElements.define('lacerta-moderator',
    class extends HTMLElement {
        ...
        constructor () {
            ...
            async function modules (obj) {
               ...
               if( obj['this'].shadowRoot.querySelector('#image') === null){
                   await store({
                   ...
                   if(template.length === 0){
                       ...
                       for(let i = 0; i < template.length; i ++){
                           ...
                           obj['this'].shadowRoot.querySelector('.main').insertAdjacentHTML('beforeend',template[i] )
                           let item = obj['this'].shadowRoot.querySelector(`.item_${i}`)
                   ...
                   await store({
                       ...
                       slot:obj['slot'],
                       type:'obj',
                       img:obj['this'].shadowRoot.querySelector('.moderator')
                   }, 'set', 'type')
