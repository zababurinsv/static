import radio from '/static/html/components/component_modules/lacerta-radio/lacerta-radio.js'

customElements.define('lacerta-radio',
  class extends HTMLElement {
    ...
    constructor () {
      ...
      async function modules (obj) {
        console.log('!!1!!!!!!!!!!1!!!!!!!!!!!!!!1!!!', radio)

          // radio['function'](obj['this'])
      }
    }
