import rotate from '/static/html/components/component_modules/rotatePoint/rotatePoint.mjs'
customElements.define('lacerta-infographics',
    class extends HTMLElement {
        constructor () {
            ...
            async function listener (obj) {
                ...
                // rotate(obj['this'].shadowRoot.querySelector('.hexagon-00'))
