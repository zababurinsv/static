import webSpeech from '/static/html/components/component_modules/speech/webSpeech.mjs'
...
customElements.define('telegram-speech',
    class extends HTMLElement {
      ...
      async function getCookie(cookie, name) {
       ...
       let speech = new (await (webSpeech({type:'speech', this:obj['this'], language: obj['this'].shadowRoot.querySelector('#select_language'), dialect:obj['this'].shadowRoot.querySelector('#select_dialect') })))['class']()

          // console.assert(false, speech)
        }
      }
      connectedCallback() {
