                ...
                case 'object':
                    (async (obj, props,data) => {
                        try {
                            ...
                            if(config['isEmpty'](queue.staticProperty[obj[props]])){
                                out(true)
                            }else{
                ...
                case 'task':
                    (async (obj, props,data) => {
                        switch (obj[props]) {
                            case 'task':
                                try {
                                    if(config['isEmpty'](queue.staticProperty['task'])){
                        ...
                        try {
                            ...
                            switch (obj[props]) {
                                ...
                                case 'object':
                                    ...
                                    break
                                case 'editor':
                                    if(config['isEmpty'](queue.staticProperty['varan-editor'])){
                        ...
                        try {
                            ...
                            switch (obj[props]) {
                                ...
                                case 'editor':
                                    ...
                                    let position = 0
                                    let count = 0
                                    // console.log(config['isEmpty'](queue.staticProperty['varan-editor']))
                                ...
                                case 'obj':
                                    ...
                                    (async (obj, props,data) => {
                                        try {
                                            ...
                                            // console.log(config['isEmpty'](queue.staticProperty['varan-editor']))
                                            // console.assert(false, queue.staticProperty)
                                            if(config['isEmpty'](queue.staticProperty[obj['target']])){
                                    ...
                                    (async (obj, props,data) => {
                                        try {
                                            ...
                                            for(let i =0; i < obj['object'].length; i++){
                                                ...
                                                if(config['isEmpty'](queue.staticProperty[obj['object'][i]])){
