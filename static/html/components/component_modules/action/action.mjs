                        ...
                        try {
                            ...
                            switch (obj[props]) {
                                case 'editor':
                                    ...
                                    if(about === undefined){
                                        if(config['store']['varan-about'] === undefined){

                                        }else{

                                            for(let i = 0 ; i < config['store']['varan-about'].length;i++){

                                                if(config['store']['varan-about'][i].slot === 'about-admin'){

                                                    about = config['store']['varan-about'][i]
                        ...
                        try {
                            ...
                            switch (obj[props]) {
                                case 'crop':
                                    ...
                                    if(config['isEmpty'](store['varan-crop'])){
                                        ...
                                        if(obj['slot'] === "moderator-admin"){
                                            ...
                                            switch (obj['slot']) {
                                                case 'telegram-login':
                                                    ...
                                                    break
                                                default:
                                                    console.warn('еобрабатываемое событие', obj['slot'])
                                                    break
                                            }
                                        }
                                    }
                        ...
                        try {
                            ...
                            switch (obj[props]) {
                                ...
                                case 'itemFeed':
                                    ...
                                    if(await config['isEmpty'](feeds['mongo'])){
                                        ...
                                        config['parseString']['parseString'](feeds['mongo'][0]['feed']['rss'], async function (err, result) {
                                            ...
                                            if(config['isEmpty'](result['rss']['channel'][0]['item']) === true){
            ...
            <enclosure url="${result['rss']['channel'][0]['item'][i]['enclosure'][0]['$']['url']}"/>
                                ...
                                case 'itemBid':
                                    (async (obj, props,data) => {
                                        ...
                                        if(await config['isEmpty'](feeds['mongo']) || feeds['mongo'] === 'null' ){
