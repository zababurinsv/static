import matcher from '/static/html/components/component_modules/matcher/module.mjs'
...
customElements.define('varan-preset',
  class extends HTMLElement {
    constructor () {
      ...
      function objectProperty (obj) {
        return new Promise(function (resolve, reject) {
          ...
          if (!obj.hasAttribute('parent')) {
            console.assert(false, 'установите атрибут')
          } else {
              ...
              external(obj)
                .then((obj) => {
                  getTemplate(obj, obj['type-swap'], obj['type-external'])
                    .then((obj) => {
                      let menu = {}
                      colorLog(`<varan-rss>template</varan-rss>`, 'red', obj)
                      // console.assert(false)
                      ...
                      colorLog(`<varan-srr>component-template</varan-srr>`, 'cornflowerblue', obj)
      ...
      async function modules (obj) {
        ...
        // await scriptVerify(obj)
        // function feedEvent (events) {
        // colorLog(`<varan-rss>feedEvent-rss-matcher-getObject</varan-rss>`, 'green', events['detail'])
        // obj['upload'] = {}
        // obj['upload']['feed'] = []
        // obj['upload']['feed'] = events['detail']
        // matcher['database']['request']['functions']['getObject'](obj)
        //   .then((obj) => { })
        // }
        // document.addEventListener('feedEvent', feedEvent, false)
      }
    }
  })
