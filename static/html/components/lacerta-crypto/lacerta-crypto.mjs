import Waves from '/static/html/components/component_modules/lacerta-crypto/lacerta-crypto.js'
// import Exchange from '/static/html/components/component_modules/lacerta-crypto/Exchange/lecerta-cryplo-sdk.js'
...
customElements.define('lacerta-crypto',
    ...
    constructor () {
      ...
      async function modules (obj) {
        /**
           ...
           *
           * */
        // obj = await  Waves['init'](obj)
        // let params = {}
        // params['amount'] = {}
        // params['price'] = {}
        // params['matcherFee'] = {}
        // params['matcherPublicKey'] =  "3N5net4nzSeeqxPfGZrvVvnGavsinipQHbE"
        // params['orderType'] =  "buy"
        // params['expiration'] =  Date.now() + 100000
        // params['amount']['tokens'] = "10"
        // params['amount']['assetId'] = "45HNfeJAbioJpmBt6aFvQCf78KPvvhnW6gKXrSh38gd3"
        // params['price']['tokens'] = "10"
        // params['price']['assetId'] = "45HNfeJAbioJpmBt6aFvQCf78KPvvhnW6gKXrSh38gd3"
        // params['matcherFee']['tokens'] = "0.1"
        // params['matcherFee']['assetId'] = "WAVES"
        // obj['waves']['order']['buy']['sign'](obj, params)
        // obj['waves']['order']['signOrder'](obj)
        // obj['waves']['order']['signAndPublishOrder'](obj)
        ...
        // obj['waves']['smart']['assets']['createScript'](obj)
        // obj['waves']['smart']['assets']['setScript'](obj)
        // obj = await   obj['waves']['issue']['setBurnToken'](obj)
        // obj = await   obj['waves']['issue']['burnToken'](obj)
        // console.assert(false, obj)
        // obj = await obj['waves']['issue']['setToken'](obj)
        // obj = await obj['waves']['issue']['issueToken'](obj)
        // console.assert(false, obj)
        // obj = await obj['waves']['sign']['setTxPackage'](obj)
        // obj = await obj['waves']['sign']['signTransactionPackage'](obj)
        // obj = await obj['waves']['sign']['setTx'](obj)
        // obj = await obj['waves']['sign']['signTransaction'](obj)
        // obj = await obj['waves']['sign']['signAndPublishTransaction'](obj)
        ...
        // await obj['waves']['on']()
        // colorLog('(~~~~(~~~(~~(~~~Waves~~~)~~)~~~)~~~~)','#3498DB  ')

        colorLog('(~~~~(~~~(~~(~~~Waves~~~)~~)~~~)~~~~)', '#3498DB  ', obj['waves'])

        /*
              "3MuZ6NCtYUrxujKKVqrBMhZ9YDwmu9wmbV6"

              3N3iQsXLQ1MjZkm37YvZ4mnkTnTHqt62Sn9
          *
          *   profit practice piece
          *   tuna orient account
          *   figure recipe about
          *   name life club wine
          *   cloth autumn
          *
          *
          *   3Mw5zEztSiF3bj5cJaSP5eDVdyMZ4hy18Z5
          *
          *   critic unusual tomato
              device spell mutual
              sorry pitch sphere
              slice wife horn switch
              milk height
          *
          * */
        // const txData = {
        ...
        //     }
        // };
        // obj['waves']['WavesKeeper'].signTransaction(txData).then((data) => {
        ...
        //     }
        // };
        // obj['waves']['WavesKeeper'].signAndPublishTransaction(txData2).then((data) => {
        //
        //     console.log('~~~~~~~~~~~~~~~~~~~~~~~~',JSON.parse(data))
        //     let transction = JSON.parse(data)
