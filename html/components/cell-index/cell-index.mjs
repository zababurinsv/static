import Tick from '/static/html/components/component_modules/cell-index/lacerta-tick/lacerta-tick.mjs'
        ...
        (async (obj)=>{
          ...
          switch (obj['slot']) {
            ...
            case 'cell-ipfs':
              ...
              break
            case 'cell-auth-stack':
              url = `http://localhost:4994`
              break
            case 'cell-auth-atlassian':
              url = `http://localhost:5004`
              break
            case 'cell-auth-github':
            ...
            case 'cell-auth-vk':
              ...
              break
            case 'cell-auth-waves':
              url = `http://localhost:4999`
              break
            case 'cell-auth-facebook':
              url = `http://localhost:5009`
              break
            case 'cell-auth-telegram':
              url = `http://localhost:5007`
              break
            case 'cell-auth-ledger':
              url = `http://localhost:4499`
              break
            case 'cell-auth-twitter':
              url = `http://localhost:4731`
              break
            case 'cell-auth-rington':
              url = `http://localhost:5007`
              break
            default:
              url = await Config()
