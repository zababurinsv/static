...
import email from '/static/html/components/component_modules/matcher/matcher/this/database/mail/mail.mjs'
import server from '/static/html/components/component_modules/matcher/matcher/this/database/server/server.mjs'
      ...
      init(obj).then(obj => {
        ...
        obj['this'].querySelector('.saveImg').addEventListener('click', (event) => {
          ...
          canvas.toBlob(async function (blob) {
            ...
            resolve(file)
            // downloadURI(URL.createObjectURL(blob, 'test'))
