...
import Module from '/static/html/components/component_modules/oscillator/RingBuffer.mjs'
import { HeapAudioBuffer, RingBuffer } from '/static/html/components/component_modules/oscillator/helper.mjs'
/**
...
class RingBufferWorkletProcessor extends AudioWorkletProcessor {
  ...
  constructor(options) {
    ...
    // console.log(Module)
    // console.assert(false, ringBuffer())
...
registerProcessor('processor', RingBufferWorkletProcessor);