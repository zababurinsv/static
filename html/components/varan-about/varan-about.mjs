...
customElements.define('varan-about',
    class extends HTMLElement {
     ...
     let about = await matcher['webdav']({
       ...
       if(obj['this'].shadowRoot.querySelector('.main') === null){


       }else{
         obj['this'].shadowRoot.querySelector('.main').innerHTML = ''
         obj['this'].shadowRoot.querySelector('.main').insertAdjacentHTML('afterbegin', about)

         if(!obj['this'].shadowRoot.querySelector('.video')){

         }else{
           obj['this'].shadowRoot.querySelector('.video').addEventListener('click', function() {


             if(obj['this'].shadowRoot.querySelector('.video').paused === true){
               obj['this'].shadowRoot.querySelector('.video').play();
             }else{
               obj['this'].shadowRoot.querySelector('.video').pause()
             }
           });
         }
       }
