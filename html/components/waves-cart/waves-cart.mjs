...
customElements.define('waves-cart',
        ...
        async function modules (obj) {
          bundle['default'](obj,null, async function (error, config) {
            ...
            switch (obj['this'].slot) {
              case 'about':
                for(let i = 0; i < object['varan-editor'].length;i++){
                  switch (object['varan-editor'][i].slot) {
                    case 'about':
                      ...
                      object['varan-editor'][i]['editor']['quill'].root.innerHTML = about
                      obj['this'].querySelector('.wall').insertAdjacentHTML('afterbegin', about)
                      break
                    default:
