customElements.define('varan-modal-button',
    class extends HTMLElement {
      ...
      function modules (obj) {
        ...
        // let slotView = obj['this'].querySelectorAll('slot')[0]
        // let slotEdit = obj['this'].querySelectorAll('slot')[1]
        // slotView.addEventListener('slotchange', function (event) {
        //   colorLog(`~~~~~~~~~~slotchange~~View~~~~~~~~`, 'sandybrown', event.path[0].assignedNodes()[0])
        // })
        // slotEdit.addEventListener('slotchange', function (event) {
        //   colorLog(`~~~~~~~~~~slotchange~Edit~~~~~~~~~`, 'sandybrown', event.path[0].assignedNodes()[0])
        // })
        // let varanCrop = {}
