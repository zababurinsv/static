    ...
    class extends HTMLElement {
        constructor () {
            ...
            async function modules (obj) {
                if(obj.this.dataset.id){
                    obj.this.shadowRoot.querySelector('div.preview').innerText = ''
                    obj.this.shadowRoot.querySelector('div.preview').innerText =  obj.this.dataset.id
                }
            }
        }
    })
