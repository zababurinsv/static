import modules from '/static/html/components/wasm-mandelbrot/external/index.mjs'
customElements.define('wasm-mandelbrot',
            ...
            .then((obj) => {
              template(obj)
                  .then((obj) => {
                    style(obj)
                        .then((obj) => {
                          modules(true, '','red', obj, 'sound-interface')
                        })
                  })
            })
      }
