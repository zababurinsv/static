import player from '/static/html/components/component_modules/lacerta-oscilloscope/lacerta-oscilloscope.js'

customElements.define('lacerta-oscilloscope',
  class extends HTMLElement {
    ...
    constructor () {
      ...
      async function listener (obj) {
        console.log('!!1!!!!!!!!!!1!!!!!!!!!!!!!!1!!!', player)

        player['function'](obj['this'])
      }
    }
