...
<script >
  ...
  components: {Navi},
    computed: {
        user () {
          console.log('System[(to-do)user]', this.$store.getters.user)
          return this.$store.getters.user
        },
        todos () {
        console.log('Global[(to-do)todos]', this.$store.getters.featuredTodos)
        return this.$store.getters.featuredTodos
