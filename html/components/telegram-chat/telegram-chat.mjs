...
import chat from '/static/html/components/component_modules/chat/chat.mjs'
customElements.define('telegram-chat',
    class extends HTMLElement {
      ...
      constructor () {
        ...
        async function modules (obj) {
          let panel = new (await chat({name:'telegram-sidebarLeft'}))['class']
          document.addEventListener('chat',async (e)=>{

            // sessionStorage.setItem('PrivateChat', e['detail']['id']);
            // panel['template'](obj,e['detail']['id'])
          })
          // document.addEventListener('updateChatLastMessage', async (e)=>{
          //   panel['updateChatLastMessage'](obj, e['detail'])
          // })
