import modules from '/static/html/components/blockchain-account/external/index.mjs'
customElements.define('blockchain-account',
                ...
                .then((obj) => {
                    template(obj)
                        .then((obj) => {
                            style(obj)
                                .then((obj) => {
                                    modules(true,0,'red',obj,'blockchain-account')
                                })
                        })
                })
        }
